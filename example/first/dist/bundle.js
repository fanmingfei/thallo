...
var firstGameObject = createGameObject({
...
// 创建一个场景
// Create a scene
var scene2 = new _Engine.Scene({ width: 400, height: 800 });
// // 创建一个 相机
// // Create a camera
var camera2 = new _Engine.Camera({
    name: "camera2",
    transform: {
        rect: new Rect({ x: 0, y: 0, width: 400, height: 800 }),
        position: new Vector2({ x: 200, y: 400 })
...
// // 创建第一个游戏对象
// // create the first game object
var firstGameObject2 = createGameObject({
    name: "firstGameObject",
    transform: {
        rect: new Rect({ x: 0, y: 0, width: 30, height: 30 })
    },
...
var thallo = new _Engine.Thallo({ canvas: canvasObj, scene: scene });
...
var Move = function (_Component) {
    ...
    function Move(_ref) {
        var targetObject = _ref.targetObject,
            _ref$dir = _ref.dir,
            dir = _ref$dir === undefined ? 1 : _ref$dir;
    ...
    _createClass(Move, [{
        ...
        value: function update(e) {
            ...
            console.log(123);
            var r = 100;
            var x = r * Math.sin(0.5 * this.dir * Math.PI * e.timeSinceSceneLoad) + 120,
